...
<h1 class="h3 mb-2 text-gray-800">Update Data WO STB Tambahan Oplang</h1>
<!-- DataTales Example -->
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-12">
                <a href="{{ url('admin/itv') }}" class="btn btn-danger btn-sm float-right"><i class="fas fa-arrow-left"></i> Kembali ke Data Indihome TV</a>
            </div>
        </div>
        <hr>
        @if(session('success'))
        ...
        @endif
        <form action="{{ url('admin/stb/update/'.$data[0]->id) }}" method="post">
            @csrf
                <div class="row">
