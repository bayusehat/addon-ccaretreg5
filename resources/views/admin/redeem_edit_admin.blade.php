...
<h1 class="h3 mb-2 text-gray-800">Upload Bukti Pengiriman</h1>
<!-- DataTales Example -->
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-12">
                <a href="{{ url('admin/redeem') }}" class="btn btn-danger btn-sm float-right"><i class="fas fa-arrow-left"></i> Kembali ke Data Redeem Point</a>
            </div>
        </div>
        <hr>
        @if(session('success'))
        ...
        @endif
        <form action="{{ url('admin/redeem/update/'.$data[0]->id) }}" method="post" enctype="multipart/form-data">
            @csrf
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm border-bottom" value="{{ $data[0]->nd_internet }}" disabled>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="nd_pots"><strong>ALAMAT PENGIRIMAN :</strong></label>
                                    <input type="text" class="form-control form-control-sm border-bottom" value="{{ $data[0]->alamat_pengiriman }}" disabled>
                                </div>
                                <div class="form-group">
                ...
                <div class="col-sm-12 col-md-6 col-xl-6">
                    ...
                    <div class="form-group">
                        <label for="attachment">Upload Bukti Pengiriman (Wajib)</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            @if ($data[0]->attachment)
                                 <img src="{{ asset('backend/img/'.$data[0]->attachment) }}" alt="Bukti pengiriman" style="height: 300px">
                            @else
                                <b><i>Bukti pengiriman belum diupload!</i></b>
                            @endif
