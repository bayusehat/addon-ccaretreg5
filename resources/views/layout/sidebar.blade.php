<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ url('admin/stb') }}">
            <i class="fas fa-fw fa-table"></i>
            <span>STB Tambahan</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ url('admin/itv') }}">
            <i class="fas fa-fw fa-table"></i>
            <span>Indihome TV / Migrasi 2P-3P</span></a>
        </li>
        @endif
        <li class="nav-item">
          <a class="nav-link" href="{{ url('admin/redeem') }}">
            <i class="fas fa-fw fa-table"></i>
