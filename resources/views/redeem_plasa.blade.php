...
<html lang="en">
  ...
  <head>
    ...
    <title>Redeem Point Plasa</title>
  ...
  --> --}}
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
                ...
                <img src="{{ asset('assets/images/rp.png') }}" style="margin-bottom:40px;width:100%">
                ...
                <form method="post" action="{{ url('registrasi_redeem_plasa') }}" enctype="multipart/form-data">
                ...
                <div class="p-3 p-lg-5 border">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            ...
                            <label for="nomor_inet">Plasa <span class="text-danger">*</span></label>

                            <select name="plasa" id="plasa" class="form-control" onchange="getWitel(this)">
                            ...
                            @error('plasa') <span class="text-danger">{{ $message }}</span>@enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            ...
                            <label for="nohp">Nomor Handphone Aktif <span class="text-danger">*</span></label>

                            <div class="form-inline">

                                <input type="phone" class="form-control col-md-11" id="nomor_hp" name="nomor_hp" placeholder="Nomor HP Aktif" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="nomor_inet" id="nomor_inet" placeholder="Nomor Internet">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            ...
                            <label for="alamat_pelanggan">Alamat <span class="text-danger">*</span></label>

                            <input type="text" class="form-control" name="alamat_pelanggan" id="alamat_pelanggan" placeholder="Alamat Pelanggan">
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-check">
                        ...
                        <input type="hidden" name="is_plasa" id="is_plasa" value="YES">
                  ...
                  <p>*Berlaku sampai dengan Desember 2021, selama persediaan masih ada</p>
    ...
    <script type="text/javascript">
        ...
        function getWitel(e){
            ...
            $.ajax({
                url : "{{ url('getwitel_redeem') }}?plasa="+plasa,
                method : "GET",
                dataType : "JSON",
                headers : {
                ...
                success:function(res){
                    if(res.status == 200){
                        $("#cwitel").val(res.result.cwitel);
                    }else{
                        alert('Terjadi kesalahan mengambil data Plasa!');
                    }
                }
            })
        }
