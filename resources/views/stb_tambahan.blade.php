...
<html lang="en">
  ...
  <head>
    ...
    <title>Indihome - STB Tambahan</title>
      ...
      <div class="site-section" id="formsect" name="formsect">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
                <img src="{{ asset('assets/images/stb.jpg') }}" style="margin-bottom:40px;width:100%">
                
                <h5 class="tebal">Hybrid Box (STB) Tambahan dan PLC</h5>
                {{--  <img src="{{ asset('assets/images/indimovie2.jpg') }}" style="margin-bottom:10px;width:100%" >  --}}
                <p>Serunya bisa nonton beragam tayangan favorit di TV berbeda dalam waktu yang bersamaan dengan Hybrid Box (STB) Tambahan. Jadi makin nyaman nonton acara TV favorit karena pemasangannya didukung dengan perangkat PLC (Power Line Communication), yaitu alat pengganti instalasi kabel yang tidak akan mengganggu estetika rumah Anda. Ciptakan keseruan nonton tayangan TV bersama keluarga di rumah dengan Hybrid Box (STB) Tambahan dari IndiHome.</p>
                <p class="tebal">Benefit yang bisa didapatkan dengan berlangganan Hybrid Box (STB) Tambahan dari IndiHome:</p>
                <p>1. Hybrid Box (STB) Tambahan dapat membantu Anda menonton tayangan IndiHome TV di TV yang berbeda dalam waktu bersamaan.</p>
                <p>2. Pemasangannya didukung dengan perangkat PLC, yaitu alat yang digunakan untuk mengurangi pemasangan kabel yang dapat mengganggu keindahan rumah.</p>

                <p class="tebal">Biaya berlangganan Hybrid Box (STB) Tambahan Rp 100.000 (Non PPN) per Bulan</p>

                <form method="post" action="{{ url('register_stb') }}">
