      ...
      <div class="site-section" id="formsect" name="formsect">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-12" style="margin: 20px 0;text-align: justify;">
              <h4>TIPE SET TOP BOX INDIHOME TV YANG SUPPORT MOLA TV</h4>
              <div class="row">
                <div class="col-md-4">
                  <p>STB ZTE B860H</p>
                  <img src="{{ asset('assets/images/mola/stb_zte.jpg') }}" style="margin-bottom:10px;width:100%" >
                </div>
                <div class="col-md-4">
                  <p>STB ZTE FIBERHOME</p>
                  <img src="{{ asset('assets/images/mola/stb_fiberhome.png') }}" style="margin-bottom:10px;width:100%" >
                </div>
                <div class="col-md-4">
                  <p>Update Firmware STB Fiberhome dengan langkah-langkah sebagai berikut :</p>
                  <ul>
                    <li>Menu setting</li>
                    <li>Pilih menu software</li>
                    <li>Pilih pembaruan secara online</li>
                    <li>Jika muncul versi firmware terbaru (RP0113) silahkan klik tombol perbarui</li>
                    <li>Klik simpan</li>
                    <li>Tunggu proses update firmware hingga selesai </li>
                    <li>STB reboot otomatis</li>
                    <li>Jika sudah masuk ke homepage, berarti update telah berhasil</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-12" style="margin: 20px 0">
              <h4>KUNCI TAYANGAN (PARENTAL CONTROL)</h4>
              <div class="row">
                @for ($i =1; $i <= 6; $i++)
                  <div class="col-md-6">
