...
<html lang="en">
  ...
  <head>
    ...
    <title>Indihome - Indihome TV</title>
    ...
    <link rel="stylesheet" href="{{ asset('backend/loading.css') }}">
    ...
    <script src="{{ asset('assets/s/main.js') }}"></script>

    <script src="{{ asset('backend/jquery.loading.min.js') }}"></script>
  ...
  -->
      ...
      <div class="site-section" id="formsect" name="formsect">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
                <img src="{{ asset('assets/images/indihometv.jpg') }}" style="margin-bottom:40px;width:100%">
                
                <h5 class="tebal">IndiHome TV</h5>
                {{--  <img src="{{ asset('assets/images/indimovie2.jpg') }}" style="margin-bottom:10px;width:100%" >  --}}
                <p>Merubah TV kita menjadi Smart TV gak perlu repot dan mahal, cukup langganan indihome TV. Dengan IndiHome TV kita juga bisa pasang aplikasi seperti Mola TV, Vidio, Catchplay, iFlix dan sudah pasti Youtube. Kita bisa menonton Youtube di televisi tanpa harus mirroring screen dari ponsel kita.</p>
                <p class="tebal">Benefit yang bisa didapatkan dengan berlangganan Indihome TV dari IndiHome:</p>
                <p class="tebal">TV on Demand</p>
                <p>Tayang ulang acara live sampai dengan 7 hari ke belakang.</p>
                <p class="tebal">TV Storage</p>
                <p>Rekam tayangan TV Anda ke dalam hard drive s/d 600 menit untuk ditonton lagi nanti.</p>
                <p class="tebal">Karaoke</p>
                <p>Hiburan di kala senggang dengan fitur karaoke di IndiHome TV.</p>

                <p class="tebal">Video on Demand</p>
                <p>Kontrol penuh video yang Anda putar di IndiHome TV.</p>

                <p class="tebal">Playback, Pause and Rewind</p>
                <p>Mundur, pause, atau putar ulang tayangan TV Anda dengan bebas.</p>


                <p class="tebal">Biaya berlangganan IndiHome TV Rp 60.000 (Non PPN) per Bulan</p>

                <form method="post" action="{{ url('register_indihometv') }}">
    ...
    <script type="text/javascript">
        ...
        function contentModal(){
            ...
            $("#fill").text('Dengan mengakses dan/atau mengisi form pada halaman situs ini, Saya menyatakan bahwa telah menerima, membaca, memahami dan menyetujui penawaran dari Telkom Indonesia untuk berlangganan IndiHome TV dengan biaya tambahan sebesar Rp. 60.000 (belum termasuk ppn). Segala risiko terkait biaya tagihan di luar kesepakatan ini sepenuhnya menjadi tanggung jawab saya.');
